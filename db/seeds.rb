...
player_franchise = Franchise.new_gridiron_franchise(city: 'Cibolo', mascot: 'Bison', league: gridiron_league)
...
User.create(email: 'test@test.com', password: '123456', franchise: player_franchise)